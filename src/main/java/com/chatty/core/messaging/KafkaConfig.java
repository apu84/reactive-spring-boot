...
//    }
    ...
    @Bean
    public ReceiverOptions<String, ChannelPostEvent> receiverOptions() {
        Map<String, Object> props = new HashMap<>();
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.chatty.core.post, com.chatty.core.messaging");
